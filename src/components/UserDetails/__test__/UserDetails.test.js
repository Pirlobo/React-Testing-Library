...
const UsersDetailsPage = () => {
    return (
        <BrowserRouter>
            <UserDetails match = {userId} validatedValues={updatedPostObject} updatedPost={updatedPostObject} />
        </BrowserRouter>
    )
}
...
describe("UserDetails", () => {
    ...
    beforeEach(() => {
        jest.mock("../../../__mocks__/getAllAlbumsByUserId")
    })

    it('should fetch and render a user element', async () => {
        render(
            <UsersDetailsPage />
        );
    ...
    it('should fetch and render an album element', async () => {
        render(
            <UsersDetailsPage />
        );
